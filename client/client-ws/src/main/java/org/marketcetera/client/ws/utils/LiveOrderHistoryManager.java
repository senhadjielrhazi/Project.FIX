 ...
 * @version $Id: LiveOrderHistoryManager.java 16841 2014-02-20 19:59:04Z colin $
 * @since 2.1.4
 */
@ClassVersion("$Id: LiveOrderHistoryManager.java 16841 2014-02-20 19:59:04Z colin $")
        ...
        implements Lifecycle
{
            ...
            throws ClientInitException
    {
        ...
        client = WSClientImpl.getInstance();
    }
    /**
    ...
    {
        if(!isRunning) {
            throw new IllegalStateException(org.marketcetera.client.ws.Messages.OPEN_ORDER_LIST_NOT_READY.getText());
        }
