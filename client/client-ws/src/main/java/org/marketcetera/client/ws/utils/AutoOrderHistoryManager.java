package org.marketcetera.client.ws.utils;
        ...
        implements ReportListener
{
    ...
    {
        throw new UnsupportedOperationException(org.marketcetera.client.ws.Messages.DONT_ADD_REPORTS.getText());
    }
    /* (non-Javadoc)
     * @see org.marketcetera.client.ws.ReportListener#receiveExecutionReport(org.marketcetera.trade.ExecutionReport)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.ws.ReportListener#receiveCancelReject(org.marketcetera.trade.OrderCancelReject)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.ws.utils.LiveOrderHistoryManager#start()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.ws.utils.LiveOrderHistoryManager#stop()
     */
    @Override
