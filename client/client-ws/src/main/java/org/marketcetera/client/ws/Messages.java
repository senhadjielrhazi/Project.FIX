...
public interface Messages {
    ...
    static final I18NMessageProvider PROVIDER =
            new I18NMessageProvider("wsclient",  //$NON-NLS-1$ 
    ...
    static final I18NMessage1P SEND_REQUEST_FAIL_NO_CONNECT =
            new I18NMessage1P(LOGGER, "send_request_fail_no_connect");   //$NON-NLS-1$
    ...
    static final I18NMessage2P SEND_REQUEST_VALIDATION_FAILED =
    ...
    static final I18NMessage1P LOG_ERROR_RECEIVE_MARKET_DATA =
            								new I18NMessage1P(LOGGER, "log_error_receive_market_data");   //$NON-NLS-1$
    static final I18NMessage1P LOG_ERROR_RECEIVE_DATA_REJECT =
            								new I18NMessage1P(LOGGER, "log_error_receive_data_reject");   //$NON-NLS-1$
    static final I18NMessage1P VALIDATION_UNKNOWN_REQUEST =
            								new I18NMessage1P(LOGGER, "validation_unknown_request");   //$NON-NLS-1$
}