...
import org.marketcetera.util.auth.UserPrincipal;
...
import static org.marketcetera.server.ws.security.Messages.*;

import java.io.IOException;
import java.security.Principal;

/**
 * Login module that authenticates with users setup in the database
 * This login module will only allow username, password combinations
 * that are persisted via the {@link SimpleUser} instances.
 * <p>
 * This login module doesn't accept any configuration options and it
 * logs to the server log file via logging mechanism.
 */
@ClassVersion("$Id: DBLoginModule.java 16154 2012-07-14 16:34:05Z colin $")
