...
import org.marketcetera.ws.server.security.MultiSimpleUserQuery;
 ...
 */
@ClassVersion("$Id: DBAdminCLI.java 16154 2012-07-14 16:34:05Z colin $")
public class DBAdminCLI
     ...
     */
    public DBAdminCLI(PrintStream out, PrintStream err) {
        this.out = out;
        this.err = err;
    }
    ...
    static final String CMD_NAME = "dbadmin"; //$NON-NLS-1$
}
