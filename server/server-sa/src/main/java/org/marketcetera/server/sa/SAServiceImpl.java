...
import org.marketcetera.client.ws.WSClientFactory;
        ...
        implements SAService
{
    ...
    private static final ModuleURN STRATEGY_PROVIDER_URN = new ModuleURN("metc:strategy:system");   //$NON-NLS-1$
    static final Set<String> EDITABLE_STRATEGY_PROPERTIES =
            Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(
                    "Parameters",  //$NON-NLS-1$
                    "RouteToServer"  //$NON-NLS-1$
            )));
    ...
    private static void failIfNotStrategy(ModuleURN inURN,
        ...
        if(!STRATEGY_PROVIDER_URN.parentOf(inURN)) {
    ...
    /**
     * default method for accessing the trade/data client factory on runtime
     */
    static volatile WSClientFactory clientFactory = new WSClientFactory() {
        @Override
     ...
     *
     * @param inParameters a <code>StrategyParameters</code> value
     * 
     * @return a <code>ModuleURN</code> value
     * @throws IOException if an error occurs creating the strategy
     */
    private ModuleURN doCreateStrategy(StrategyParameters inParameters)
            throws IOException
    {
        ...
        return mManager.createModule(STRATEGY_PROVIDER_URN,
                                        ...
                                        inParameters.isRouteToServer(),
                                        clientFactory,
                                        REMOTE_RECEIVER);        
    }    
    
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#getProviders(org.marketcetera.util.ws.stateful.ClientContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#getInstances(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#getModuleInfo(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#start(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#stop(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#sendData(org.marketcetera.util.ws.stateful.ClientContext, java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#delete(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#getProperties(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#setProperties(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.module.ModuleURN, java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.marketcetera.client.sa.SAService#createStrategy(org.marketcetera.util.ws.stateful.ClientContext, org.marketcetera.client.sa.StrategyParameters)
     */
    @Override
    public ModuleURN createStrategy(ClientContext inCtx,
                                    final StrategyParameters inParameters)
            throws RemoteException
    {
