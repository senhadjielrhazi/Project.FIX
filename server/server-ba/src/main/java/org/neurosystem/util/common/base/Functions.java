...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link org.neurosystem.util.common.collect.BiMap BiMap} (or can be one), you
   * can use {@link org.neurosystem.util.common.collect.Maps#asConverter Maps.asConverter} instead to get a
