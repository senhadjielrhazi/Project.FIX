 ...
 * an example round-trip using {@link org.neurosystem.util.common.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     org.neurosystem.util.common.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     org.neurosystem.util.common.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
