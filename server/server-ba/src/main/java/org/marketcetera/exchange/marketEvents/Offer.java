 ...
 *
 */
public class Offer extends MarketEvent {
	
	/**
	 * @see MarketEvent#MarketEvent(double, int, int, String, Date, String, char, String, String)
	 */
	public Offer(double orderPrice, int orderQty, int remainingQty, String clientOrderID,
	 ...
	 * @param marketEvent
	 */
	public Offer(MarketEvent marketEvent) {
