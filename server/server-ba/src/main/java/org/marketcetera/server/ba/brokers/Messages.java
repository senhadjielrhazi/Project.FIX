...
public interface Messages
{
    ...
    static final I18NMessageProvider PROVIDER=
        new I18NMessageProvider("ba_brokers"); //$NON-NLS-1$
    ...
    static final I18NMessage0P NO_DATA_BROKER=
            new I18NMessage0P(LOGGER,"no_data_broker"); //$NON-NLS-1$
    static final I18NMessage0P NO_TRADE_BROKER=
            new I18NMessage0P(LOGGER,"no_trade_broker"); //$NON-NLS-1$
    ...
    static final I18NMessage2P ERROR_REQUEST_UNKNOWN=
            new I18NMessage2P(LOGGER,"error_request_unknown"); //$NON-NLS-1$
    static final I18NMessage2P ERROR_RESPONSE_DATA=
            new I18NMessage2P(LOGGER,"error_response_data"); //$NON-NLS-1$
    static final I18NMessage2P ERROR_REQUEST_PROCESS=
            new I18NMessage2P(LOGGER,"error_request_process"); //$NON-NLS-1$
