...
public interface Messages
{
    ...
    static final I18NMessageProvider PROVIDER= 
        new I18NMessageProvider("ba");  //$NON-NLS-1$
    ...
    static final I18NMessage2P ERROR_LOGON_USERPASSWORD=
            new I18NMessage2P(LOGGER,"error_logon_userpassword"); //$NON-NLS-1$
    
    static final I18NMessage0P CLIENT_ERROR_CONNECTION=
            new I18NMessage0P(LOGGER,"client_error_connection"); //$NON-NLS-1$
}
