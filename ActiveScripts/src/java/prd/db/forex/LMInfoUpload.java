...
public class LMInfoUpload extends Strategy {
    ...
    public void onStart() {
        ...
        BigDecimal inContractSize = BigDecimal.valueOf(10000.);
        BigDecimal inMinSize = BigDecimal.valueOf(0.1);
        BigDecimal inTradeFee = BigDecimal.valueOf(30./1000000.);
        ...
        inInstrument = new Currency("USD/HKD");
        inInfo = new CurrencyInfo(
        		inContractSize, 
        		inMinSize, 
        		BigDecimal.valueOf(0.00001), 
        ...
        inInstrument = new Currency("EUR/HKD");
        inInfo = new CurrencyInfo(
        		inContractSize, 
        		inMinSize, 
        		BigDecimal.valueOf(0.00001), 
        ...
        inInstrument = new Currency("GBP/HKD");
        inInfo = new CurrencyInfo(
        		inContractSize, 
        		inMinSize, 
        		BigDecimal.valueOf(0.00001), 
        ...
        inInstrument = new Currency("GBP/SEK");
        inInfo = new CurrencyInfo(
        		inContractSize, 
        		inMinSize, 
        		BigDecimal.valueOf(0.00001), 
        ...
        /****************************************************NZD*************************************************/       
        inInstrument = new Currency("NZD/CHF");
        inInfo = new CurrencyInfo(
        		inContractSize, 
        		inMinSize, 
        		BigDecimal.valueOf(0.00001), 
